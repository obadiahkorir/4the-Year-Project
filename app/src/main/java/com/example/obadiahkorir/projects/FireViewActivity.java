...
/**
 * Created by Obadiah Korir on 8/6/2018.
 */

public class FireViewActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new FireViewActivity.GetHttpResponse(this).execute();
    }
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            FireViewActivity.HttpService httpService = new FireViewActivity.HttpService("https://chemisoftsolutions.000webhostapp.com/android/courses.php");
            try
            {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_refresh) {
            Intent refresh = new Intent(this, FireViewActivity.class);
