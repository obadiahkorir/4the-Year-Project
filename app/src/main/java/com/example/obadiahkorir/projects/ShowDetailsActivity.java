...
public class ShowDetailsActivity extends AppCompatActivity {
    ...
    String HttpURL = "https://chemisoftsolutions.000webhostapp.com/android/CategoryFilter.php";
    String ParseResult ;
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void result)
        {
            ...
            arrayAdapter = new ArrayAdapter<String>(ShowDetailsActivity.this,android.R.layout.simple_list_item_2, android.R.id.text1, listString);
