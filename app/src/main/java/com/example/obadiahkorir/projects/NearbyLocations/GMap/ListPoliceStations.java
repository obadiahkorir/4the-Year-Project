package com.example.obadiahkorir.projects.NearbyLocations.GMap;
...
import com.example.obadiahkorir.projects.Adapter.CustomPlacesAdapter;
import com.example.obadiahkorir.projects.HospitalActivity;
import com.example.obadiahkorir.projects.NearbyLocations.GeometryController;
...
/**
 * Created by Obadiah Korir on 10/24/2018.
 */

public class ListPoliceStations extends AppCompatActivity {
        ...
        scanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(ListPoliceStations.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListPoliceStations.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    HospitalActivity.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
    ...
    void viewMapButton() {
         ...
         * @param MapsActivity
         * */
        Intent intent = new Intent(ListPoliceStations.this, MapsActivity.class);
    ...
    void loadLocation() {
        try {
            new ListPoliceStations.RetrieveFeedTask().execute();
        ...
        protected StringBuffer doInBackground(StringBuffer... stringBuffers) {
            try {
                ...
                StringBuilder stringBuilder = new StringBuilder()
                        .append("https://maps.googleapis.com/maps/api/place/search/json?rankby=distance&keyword=police&location=")
                        .append(latitude)
                        .append(",")
                        .append(longitude)
                        .append("&key=AIzaSyCFi2UFYdPPfMi5-7K5n_KNNlrUrdWSQ5Y&sensor=false&libraries=places");
