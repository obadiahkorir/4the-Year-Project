...
/**
 * Created by CHEMISOFT on 6/24/2018.
 */
...
import com.example.obadiahkorir.projects.NearbyLocations.GMap.ListPoliceStations;
...
public class PoliceActivity extends AppCompatActivity {
    ...
    void hospitalLocations() {
        if(isNetworkAvailable()) {
            ...
            Intent intent = new Intent(PoliceActivity.this, ListPoliceStations.class);
            startActivity(intent);
        }else
