...
import com.example.obadiahkorir.projects.Web.Constants;
public class SpecialNeeds extends AppCompatActivity {
    ...
    public void initializeCall() {
        ...
        if (textSound != null) {
            switch (textSound) {
                case "police":
                    String policenumber = "0727045828";
            ...
            final String callnumber = "0727045828";

            Intent callIntent4 = new Intent(Intent.ACTION_CALL);
            callIntent4.setData(Uri.parse("tel:" + Uri.encode(callnumber)));
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                // TODO: Consider calling
                //    ActivityCompat#requestPermissions
                // here to request the missing permissions, and then overriding
