...
public class CorruptionActivity  extends AppCompatActivity  implements
  ...
  private int mYear, mMonth, mDay, mHour, mMinute;
        ...
        String HttpUrl = "https://chemisoftsolutions.000webhostapp.com/android/corruption_insert.php";
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    spinner2.setOnItemSelectedListener(this);
        ...
        requestQueue = Volley.newRequestQueue(CorruptionActivity.this);

        progressDialog = new ProgressDialog(CorruptionActivity.this);
...
public void onErrorResponse(VolleyError volleyError) {
        ...
        Toast.makeText(CorruptionActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
        }
        }) {
@Override
protected Map<String, String> getParams() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(CorruptionActivity.this);
...
public void GetValueFromEditText(){
        ...
        if(TextUtils.isEmpty(FirstNameHolder)) {
                FirstName.setError("Please Fill in the Corruption Description.");
                return;
        }
...
public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.corruption, menu);
        return true;
        }
@Override
