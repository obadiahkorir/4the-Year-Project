...
public class AccidentActivity extends AppCompatActivity implements
    ...
    String HttpUrl = "https://chemisoftsolutions.000webhostapp.com/android/accident_insert.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(AccidentActivity.this);

        progressDialog = new ProgressDialog(AccidentActivity.this);
        ...
        InsertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(AccidentActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(AccidentActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                            }
                        }) {
                    @Override
                    protected Map<String, String> getParams() {
                        ...
                        params.put("accidenttype", AccidentTypeHolder);
                        params.put("accidenttime", TimeHolder);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(AccidentActivity.this);
